...
```
20. Что такое интерфейс? Зачем он нужен? | Интерфейс - способ взаимодействия между классом и пользователем, объявляет в себе только абстрактные методы, также нельзя создавать объект интерфейса
